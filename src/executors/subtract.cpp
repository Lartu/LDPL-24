...
class SUBTRACT_Statement_Executor : public Statement_Executor
{
private:
    NUMBER _constant = 0;
...
public:
    SUBTRACT_Statement_Executor(NUMBER *operand_1, NUMBER *operand_2, NUMBER constant, NUMBER *destination)
    {
        _constant = constant;
    ...
    void execute(size_t *program_counter, LDPL_Execution_State *state) override
    {
        ...
        {
            *_destination = _constant - *_operand_1;
        }
        else if (type == 2)
        {
            *_destination = *_operand_2 - _constant;
        }
        else if (type == 3)
        {
            *_destination = *_operand_2 - *_operand_1;
        }
    }
};