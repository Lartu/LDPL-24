...
class MULTIPLY_Statement_Executor : public Statement_Executor
{
private:
    NUMBER _constant = 0;
...
public:
    MULTIPLY_Statement_Executor(NUMBER *operand_1, NUMBER *operand_2, NUMBER constant, NUMBER *destination)
    {
        _constant = constant;
